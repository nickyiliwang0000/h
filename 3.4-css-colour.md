...
Mess with the values in this CodePen to see how the alpha channel works.

<iframe src="https://codepen.io/hackeryou/pen/YRyQvR"></iframe>

## Opacity vs. alpha channel
Take a look at this CodePen and figure out the difference between the CSS property `opacity` and the alpha channel.
<!-- Explain to students that opacity affects all of an element's children -->
<iframe src="https://codepen.io/hackeryou/pen/QJjgNL"></iframe>
