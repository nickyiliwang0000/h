...
A radial gradient allows you to create a circular gradient as a background. Its syntx is siilar to that of a linear gradient but doesn't require an angle.
