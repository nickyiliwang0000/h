...
- 2018-coca-cola-microsite
  ...
  - images
      ...
      logo.png
```
<!-- Check out `1.2 Keeping organized as a developer` for a more in-depth look at organization. -->
...
> In the future we'll learn about grid systems. Grid systems are used for layout, sometimes in concert with flexbox or floats. Think of them as members of the first group.
