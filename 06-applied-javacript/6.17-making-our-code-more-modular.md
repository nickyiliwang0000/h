...
We place the name of the function that we want to import from the `randomizer` module inside the curly brackets. This curly bracket syntax is new in ES6 and [is called destructuring](https://github.com/HackerYou/bootcamp-notes/blob/master/06-applied-javacript/6.16-advanced-js-destructuring-immutability-and-purity.md#destructuring-objects).
