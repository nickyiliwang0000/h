...
### a[href="https://www.hackeryou.com"]
This selector finds a link whose `href` value is **exactly** what's in the quotes and applies the specified styles.

### a[href*="hack"]
This selector finds a link whose `href` value **contains** what's in the quotes and applies the specified styles.

### `a[href^="https://"]`
This selector finds a link that **starts with** what's in the quotes and applies the specified styles.

### `a[href$="jpg"]`
This selector finds a link that **ends with** what's in the quotes and applies the specified styles.
