...
### `name`
Each input should have a name. Sometimes, as iwithn checkboxes (which we'll look at a little further down the page), the same name is used to denote a grouping of inputs. Other times, it's information about what the input is for.
