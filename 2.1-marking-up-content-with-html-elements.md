...
<p>It's better to use actual text rather than images with text in them. Screen readers can't read the text in images, they can only read alt text on the `img` element. Also, when images with text are zoomed, they can lose readability and become pixelated. </p>
</div>
...
If you've ever made a website, chances are you've used an anchor tag.  Anchor tags (also called links or anchor links) allow us to create a path to another web page or to places within our site.
...
```html
	...
	<a href="https://www.hackeryou.com">Visit the HackerYou site!</a>
	<!-- links within our website -->
	<a href="about.html">Visit my about page</a>
	<!--linking a nested image to another page -->
	<a href="contact.html">
		<img src="images/contact.png" alt="Envelope icon">
	</a>
```
