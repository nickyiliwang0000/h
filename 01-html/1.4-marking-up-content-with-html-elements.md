...
<p>There are lots of colors I like: <span class="contains-red" bg-color="red" >red</span>, blue, <span class="contains-red" style="background:red; color:#fff;" >purple</span>, green to name a few.</p>
